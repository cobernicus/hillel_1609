...
"""
count_b = adwentures_of_tom_sawer.count('b')
print('Count of "b" letter in a text is:', count_b)
...
print("Second Tom position is:", second_tom)

uppercase = adwentures_of_tom_sawer.split()
res = len([word for word in adwentures_of_tom_sawer if word[0].isupper()])
print('Count of uppercase words in a text is:', res)
# task 06
